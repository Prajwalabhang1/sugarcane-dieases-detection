...
const CameraHandler = {
    ...
    async startCamera(retryCount = 0) {
        try {
            // this.showToast(this.messages.requesting, 'info'); // Removed to reduce notification spam
            ...
            // this.showToast(this.messages.starting, 'info'); // Removed to reduce notification spam
            ...
            // Auto-scroll to camera section for better UX
            setTimeout(() => {
            ...
            // Commented out to reduce notification spam
            // setTimeout(() => {
            //     if (this.state.isActive) {
    ...
    async capturePhoto() {
        ...
        try {
            ...
            // Auto-scroll to show both captured photo and analyze button
            setTimeout(() => {
                // Scroll to preview container to show image + buttons together
                const previewContainer = document.getElementById('preview-container');
                if (previewContainer) {
                    previewContainer.scrollIntoView({
                        behavior: 'smooth',
                        block: 'start'  // Align to top of viewport to show full preview
                    });
                }
            }, 500); // Wait for preview to render
